...
class Scoreboard():
    ...
    def show_score(self):
        # Выводит текущий счет, рекорд и число оставщихся кораблей (жизней).
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render("Рекорд:" + high_score_str, True,
    ...
    def prep_ships(self):
        """Сообщает кол-во оставщихся кораблей (жизней)"""
        self.ships = Group()
        for ship_number in range(self.stats.ships_left):
            ship = Ship(self.ai_game)
            #ship.rect_heart.x = 10 + ship_number * ship.rect_heart.width
            #ship.rect_heart.y = 10
